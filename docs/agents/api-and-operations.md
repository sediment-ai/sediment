...
| `scripts/capacity_rehearsal.py`; `scripts/agent_evidence_benchmark.py` | Disposable mixed capture/retrieval/report/export measurements; strict profiles, resource-free `--plan-only`, complete histories, receipt conservation, and scoped resource measurements. See [Profile reports and Derivations](../operate/profile-derivations.md#rehearse-capture-alongside-batch-work) |
