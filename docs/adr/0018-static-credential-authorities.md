...
Status: accepted; [ADR 0022](0022-agent-requested-session-context.md) adds fixed Session retrieval authority; [ADR 0023](0023-authorized-session-candidate-discovery.md) extends it to an explicit Session set.
